...
namespace FiLogger.Context.Migrations
{
    ...
    [Migration("20190218095250_seed-data")]
            ...
            modelBuilder.Entity("FiLogger.Common.Models.CustomerDetails", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DistanceSellingId = 1,
                            FirstContactDate = new DateTime(2019, 2, 18, 9, 52, 50, 332, DateTimeKind.Local).AddTicks(6822),
                            FirstName = "Tommy",
                            FranchiseId = 1,
            ...
            modelBuilder.Entity("FiLogger.Common.Models.DeferredProductStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DeferredProductId = 1,
                            CustomerId = 1,
                            PresentationDate = new DateTime(2019, 2, 18, 9, 52, 50, 329, DateTimeKind.Local).AddTicks(7575),
