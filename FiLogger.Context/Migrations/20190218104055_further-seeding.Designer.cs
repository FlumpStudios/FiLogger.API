...
namespace FiLogger.Context.Migrations
{
    ...
    [Migration("20190218104055_further-seeding")]
            ...
            modelBuilder.Entity("FiLogger.Common.Models.CoverDetails", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CoverDetailsId = 1,
                            CoverStartDate = new DateTime(2019, 2, 18, 10, 40, 55, 235, DateTimeKind.Local).AddTicks(4142),
                            IsProductOnMainOrder = false,
                            PolicyClaimLimitId = 1,
                            PolicyDurationId = 1,
                            PresentationDate = new DateTime(2019, 2, 18, 10, 40, 55, 235, DateTimeKind.Local).AddTicks(5684),
                            ProductId = 1,
                            RetailPrice = 5000m,
                            TreatmentDate = new DateTime(2019, 2, 18, 10, 40, 55, 235, DateTimeKind.Local).AddTicks(6884),
            ...
            modelBuilder.Entity("FiLogger.Common.Models.CustomerDetails", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DistanceSellingId = 1,
                            FirstContactDate = new DateTime(2019, 2, 18, 10, 40, 55, 234, DateTimeKind.Local).AddTicks(7742),
                            FirstName = "Tommy",
                            FranchiseId = 1,
            ...
            modelBuilder.Entity("FiLogger.Common.Models.DeferredProductStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DeferredProductId = 1,
                            CustomerId = 1,
                            PresentationDate = new DateTime(2019, 2, 18, 10, 40, 55, 233, DateTimeKind.Local).AddTicks(4238),
            ...
            modelBuilder.Entity("FiLogger.Common.Models.VehicleDetails", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CurrentMileage = 50m,
                            CustomerId = 1,
                            DateRegistered = new DateTime(2019, 2, 18, 10, 40, 55, 227, DateTimeKind.Local).AddTicks(5856),
                            EngineSize = "999cc",
                            IsFinanced = false,
                            IsNew = false,
                            Keyword1 = "White",
                            ...
                            Manufacturer = "SEAT",
                            Model = "Arona",
                            PurchasedDate = new DateTime(2019, 2, 18, 10, 40, 55, 229, DateTimeKind.Local).AddTicks(3022),
